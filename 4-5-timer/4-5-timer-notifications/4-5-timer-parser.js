...
function timingParserToSeconds(inputArray) {
   // console.log(inputArray)
    ...
    return (Number(timerValues[0]) * 3600 + Number(timerValues[1]) * 60 + Number(timerValues[2]));
}

module.exports = timingParserToSeconds;
