...
- разработка и описание пользовательских требований (Use cases, User stories, User stories mapping);
...
- выделение агрегатов доменных областей
...
**Релиз 1**  
_регистрацию не реализовываем_
...
- слой работы с репозиторием (repository)
- слой middleware
