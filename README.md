...
> Бизнес-контекст (black box): Контекстная диаграмма (данные)
> + диаграмма бизнес Use cases (функции)  
> Переходный уровень (grey box): Диаграмма концептуальных классов (данные) + реестр системных Use
> cases (функции)  
> Системный уровень (white box): Диаграмма классов или
