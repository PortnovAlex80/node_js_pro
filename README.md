...
Краткая суть проекта для экономии времени: в репозитории предоставлена документация на учебный проект WMS, разработанная начиная от бизнес-требований до диаграммы классов и проектирования REST API. Те, представлена проектная работа. Так же в репозитории расположено написанное мною бекенд-приложение, включая REST API (включая swagger) и Telegram-bot, реализующее проектные решения. Те, данное портфолио раскрывает полный процесс разработки от разработки требований до реализации, включая диаграмму Ганта работы над проектом. В проекте осуществлена трассировка требований в проектное решение, и далее в реализацию в коде.
