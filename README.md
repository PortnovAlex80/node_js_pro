...
Во второй части портфолио планируется представить (проработано в черновиках):
...
**Опыт с проектов:**
На доске Канбан команды разработки должны быть только те задачи, которые имеют DOR:  
Описаны User story   
Наличие критекриев приемки  
Проведена техническая декомпозиция задач (бек, фронт)  
Готовы макеты UI  
Есть оценки тимлидов  
Внешние интеграции готовы (например, готово REST API)  
Тестовые стенды готовы  
и т.д.  
  
Иначе задачи потом блочатся на этапе взятия в спринт  
