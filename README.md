...
| **Предусловия**    |
| **Триггер** Работник склада получил Товарную накладную от водителя. |
...
| 1а. Если Работник склада не выполняет задание в течение определенного периода времени (BRULE-XX), система должна отправить уведомление или эскалировать ситуацию на следующий уровень управления (BRULE-XX). |
