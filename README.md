...
> Примечание: некоторые команды разработки **против** детального
> документирования структур объектов, так как очень сложно и
> поддерживать документацию в актуальном состоянии, плюс иногда
> аналитики могут не учесть важных при реализации моментов. Но все же,
> для примера приведем возможные варианты описания структуры объектов в
